...
import com.nomoreft.paymentservice.payment.test.PaymentDatabaseHelper
...
class CheckoutServiceTest(
    ...
    fun `should fail to save PaymentEvent and PaymentOrder when trying to save for the second time`() {
        ...
        val block = checkoutUseCase.checkout(checkoutCommand).block()
